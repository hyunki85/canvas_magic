 ...
 */
public abstract class CDrawable implements Serializable {
    private int id;
    ...
    public CDrawable(int id, int x, int y, int height, int width, Paint mPaint, List<CTransform> mTransforms) {
        this.id = id;
        this.x = x;
        this.y = y;
        this.height = height;
